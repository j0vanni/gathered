...
function Login() {
  ...
  const handleGoogleLogin = () => {
    ...
    console.log(__ENV__.GOOGLE_CLIENT_ID);
    console.log(__ENV__.GOOGLE_CLIENT_SECRET);
    console.log(__ENV__.JWT_SECRET);
    console.log(__ENV__.SESSION_SECRET);
    console.log(__ENV__.TMDB_API_KEY);
